...
if( signal[0]=="green" )
    {
        console.log("Signal is green ! You can cross the raod.")

    }
    else if(signal[2]=="yellow" )
    {
        console.log("Signal is yellow ! Stop walking.")
    }
    else{
        console.log("Siganl is Red! Don't trying to cross the  road. ")
    }
