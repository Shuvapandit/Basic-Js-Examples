...
function paperRequirements(numberofbooksCopy1,numberofbooksCopy2,numberofbooksCopy3)
{
    let numberofpages1;
    let numberofpages2;
    let numberofpages3;
    numberofpages1=numberofbooksCopy1*100;
   
    numberofpages2=numberofbooksCopy2*200;
     numberofpages3=numberofbooksCopy3*300;
return [numberofpages1,numberofpages2,numberofpages3]

}
let output=paperRequirements(2,3,4);
console.log(output)